...
import 'package:volunteersapp/modules/user/presentation/cubits/user_cubit.dart';
import 'package:volunteersapp/modules/user/presentation/state/user_page_state.dart';
import 'package:volunteersapp/widgets/formtextfields.dart';
                          ...
                          FormTextFields(
                            listFormTextFields: [
                              FormTextField(
                                ...
                                enable: true,
                                textFormFieldInputDecorationlabel: 'Name',
                              ...
                              FormTextField(
                                ...
                                formKey: GlobalKey<FormState>(),
                                enable: true,
                                textFormFieldInputDecorationlabel: 'city',
                                keyboardType: TextInputType.text,
                                textInputAction: TextInputAction.next,
                              ),
                              FormTextField(null,
                              ...
                              FormTextField(
                                ...
                                formKey: GlobalKey<FormState>(),
                                enable: true,
                                textFormFieldInputDecorationlabel: 'Country',
                                keyboardType: TextInputType.text,
